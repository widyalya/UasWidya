...
public class DataProvider {
    ...
    private static List<Ular> initDataTikus(Context ctx) {
        ...
        ulars.add(new Ular(ctx.getString(R.string.Ular_nama), ctx.getString(R.string.Ular_cobra_asal),
                ctx.getString(R.string.Ular_cobra_deskripsi), R.drawable.ularracun));
        ulars.add(new Ular(ctx.getString(R.string.Ular_nama), ctx.getString(R.string.Ular_sendok_asal),
                ctx.getString(R.string.Ular_sendok_deskripsi), R.drawable.ularsendok));
        ulars.add(new Ular(ctx.getString(R.string.Ular_nama), ctx.getString(R.string.Ular_hijau_asal),
                ctx.getString(R.string.Ular_hijau_deskripsi), R.drawable.ularijo));
        return ulars;
    }
